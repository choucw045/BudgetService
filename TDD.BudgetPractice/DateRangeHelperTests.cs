...
public class DateRangeHelperTests
{
    ...
    {
        var valueTuples = DateRangeHelper.SplitDaysCountByMonth(new DateTime(2023, 1, 1), new DateTime(2023, 1, 1));
    ...
    {
        var valueTuples = DateRangeHelper.SplitDaysCountByMonth(new DateTime(2023, 1, 1), new DateTime(2023, 2, 1));
    ...
    {
        var valueTuples = DateRangeHelper.SplitDaysCountByMonth(new DateTime(2023, 1, 1), new DateTime(2023, 3, 1));
    ...
    {
        var valueTuples = DateRangeHelper.SplitDaysCountByMonth(new DateTime(2023, 1, 15), new DateTime(2023, 3, 1));
        valueTuples.Count().Should().Be(3);
